...
class SceneMeshEntry:
    def __init__(self, obj_file: str, transform: dict, vertex_colors: Optional[List[List[float]]] = None, default_color: Optional[List[float]] = None, texture_file: Optional[str] = None, generate_texture: Optional[str] = None):
...
class SceneDefinition:
    def __init__(self, camera: CameraParameters, meshes: List[SceneMeshEntry], output: str, background: List[float]):
        self.camera = camera
        self.meshes = meshes
        self.output = output
