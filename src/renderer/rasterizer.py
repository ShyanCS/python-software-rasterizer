...
def rasterization(
    ...
    for screen_x, screen_y, barycentric in coverage.covered_samples(p0, p1, p2, area, bbox):
        depth_value = depth_reconstruct.reconstruct(p0[2], p1[2], p2[2], barycentric)

        texcoord = interpolation.interpolate(
            triangle.v0.texcoord,
            triangle.v1.texcoord,
            triangle.v2.texcoord,
            triangle.v0.clip_w,
            triangle.v1.clip_w,
            triangle.v2.clip_w,
            barycentric,
